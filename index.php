...
<body>
    ...
    <div class="img-overlay">
        ...
        <div class="heading">
               <h1 class="your">LIGHTEN THE LIFE OF A CHILD</h1>
                    ...
                    <div class="col-md-5 col-md-offset-2 containers hello">
                        <div class="about-heading">
                           <h4 style="color:black;">ABOUT US</h4>
                            <h2 style="color:black;">Welcome to our <span style="color:#fda401;">NGO</span></h2>
                        </div>
                        <!--.about-heading-->
                        ...
                        <div class="read-button">
                            <a href="" class="btn btn-sm btn-general orange orange1" role="button">Read More</a>
                        </div>
                    </div>
                    <!--.col-md-6-->
                    <div class="col-md-5">
